...
## Парсинг Телеграмм
Для работы с приложением необходимо выгрузить сообщения из чата Телеграм с помощью API Telegram. В случае, когда необходима только демонстрация приложения, достаточно применить файл data.csv, расположенный в репозитории.
...
Web-приложение разделяет сообщения выгруженные из чата Телеграмм на 3 категории:
